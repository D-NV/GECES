...
def calcFitness(tree, sample, index):
    ...
    for i in sample:
        ...
        if float(t.root.data) > 0:
            ...
            # elif index == 7:
            #     out = 7
        if (out == 0 and (i[-1] in range(1, 4))) or (out != 0 and (i[-1] not in range(1, 4))):
            fitness += 1
            # print(fitness)
        else:
            fitness += 0
...
while 1:
    ...
    if a == 1:
        ...
        for j in currentGeneration[-1].trees:
            for k in testing_data:
                ...
                if out > 0:
                    ...
                    if res is None and k[-1] not in range(1, 4) and currentGeneration[-1].trees.index(j) == 0:
                        accPos += 1
                        # print("Fear = ", accFear0)
                    elif res is None and (k[-1] != 0 and k not in range(4, 7)) and currentGeneration[-1].trees.index(j) == 1:
                        accNeg += 1
                    ...
                    elif res is None and k[-1] != 7 and currentGeneration[-1].trees.index(j) == 2:
                        accNeutral7 += 1
                        # print("neutral = ", accNeutral7)
                if res == 0 and k[-1] in range(1, 4):
                    accPos += 1
                    # print("Fear = ", accFear0)
                elif res == 1 and (k[-1] == 0 or k[-1] in range(4, 7)):
                    accNeg += 1
                #     # print("Tenderness = ", accTenderness1)
        ...
        accPos = (accPos/float(len(testing_data)))*100
        accNeg = (accNeg / float(len(testing_data))) * 100
        ...
        # print("Accuracy for Class 5 or Disgust is ", accDisgust5, "%")
        # print("Accuracy for Class 6 or Anger is ", accAnger6, "%")
        print("Accuracy for Class 0 or Positive Emotion is ", accPos, "%")
        print("Accuracy for Class 1 or Negative Emotion is ", accNeg, "%")
        print("Accuracy for Class 2 or Neutral is ", accNeutral7, "%")
        print("\n \n")
        avgaccuracy = (accPos+accNeg+accNeutral7)/float(3)
