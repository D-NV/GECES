...
def calcFitness(tree, sample, index):
    ...
    for i in sample:
        ...
        if float(t.root.data) > 0:
            ...
            out = 7
        if (out == 0 and i[-1] in range(0, 7)) or (out == 7 and i[-1] == 7):
            fitness += 1
            # print(fitness)
        else:
            fitness += 0
...
while 1:
    ...
    if a == 1:
        ...
        while 1:
            ...
            for i in currentGeneration:
                ...
                for j in i.trees:
                    ...
                    fit = calcFitness(tree, training_data, 0)
                    # print(fit)
                    count += 1
                    # print(fit)
                    # print(j.fitness)
        ...
        accEmotion = (accEmotion/float(len(testing_data)))*100
        ...
        # print("Accuracy for Class 5 or Disgust is ", accDisgust5, "%")
        # print("Accuracy for Class 6 or Anger is ", accAnger6, "%")
        print("Accuracy for Class 0 or Emotion is ", accEmotion, "%")
        print("Accuracy for Class 1 or Neutral is ", accNeutral7, "%")
        print("\n \n")
        avgaccuracy = (accEmotion+accNeutral7)/float(2)
