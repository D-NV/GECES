...
def calcFitness(tree, sample, index):
    ...
    for i in sample:
        ...
        #     fitness += 1
            # print(fitness)
        if (out == 0 and 0<=i[-1]<7) or (out == -1 and i[-1] == 7 and out == 0):
            fitness += 1
        elif (out == 7 and i[-1] == 7) or (out == -1 and i[-1] != 7 and out == 7):
            fitness += 1
        else:
            fitness += 0
...
def crossover(t1, t2, sample, index):
    ...
    while 1:
        if cycle < 30:
            ...
            if (fit_new_a > fit_a and fit_new_a > fit_b) and (fit_new_b > fit_a and fit_new_b > fit_b):
                break
...
while 1:
    ...
    if a == 1:
        ...
        #
        accEmotion = (accEmotion / len(testing_data)) * 100
        accNeutral7 = (accNeutral7 / len(testing_data)) * 100

        print("Testing completed on test data.")
        print("Accuracy for Valence is ", accEmotion, "%")
        print("Accuracy for Neutral is ", accNeutral7, "%")
        ...
        avgaccuracy = (accEmotion + accNeutral7)/2
        print("Overall average accuracy of classifier is ", avgaccuracy, "%")
        # print("\n")
